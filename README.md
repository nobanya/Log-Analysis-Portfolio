...
2. Open the project you wish to complete and carefully follow the instructions outlined in the corresponding project file.

3. Review and satisfy the pre-requisites for each project, ensuring all required tools and configurations are in place before starting.
